...
$data1 = json_decode(exec('python3 getMeas.py day m_key_rh '.$dataCount),true);
$data2 = json_decode(exec('python3 getMeas.py day m_met_p '.$dataCount),true);
...
/* color of lines */
 ...
 $myPicture->drawText(150,35,"Vlhkost a tlak za poslednich 60 dni",array("FontSize"=>20,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE));
