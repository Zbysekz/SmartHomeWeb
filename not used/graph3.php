...
$data1 = json_decode(exec('python3 getMeas.py hour m_met_u '.$dataCount),true);
...
for ($x = $dataCount-1; $x >=0 ; $x--) {
 ...
 $myPicture->drawText(150,35,"Napeti za poslednich 24h",array("FontSize"=>20,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE));
