...
$data1 = json_decode(exec('python3 getMeas.py day m_key_t '.$dataCount),true);
$data2 = json_decode(exec('python3 getMeas.py day m_met_t '.$dataCount),true);
...
for ($x = $dataCount-1; $x >=0 ; $x--) {
 ...
 $myPicture->drawText(150,35,"Teplota za poslednich 60 dni",array("FontSize"=>20,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE));

 /* Set the default font */
 $myPicture->setFontProperties(array("FontName"=>"fonts/pf_arma_five.ttf","FontSize"=>8));

 /* Define the chart area */
 $myPicture->setGraphArea(60,40,1500,200);
